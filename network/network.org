...
- SW1
  #+BEGIN_EXAMPLE
    ...
    spanning-tree mst configuration
     name CUMT
     revision 1
     instance 1 vlan 1, 3, 5, 7
     instance 2 vlan 2, 4, 6, 8
    !
  #+END_EXAMPLE
- SW2
  #+BEGIN_EXAMPLE
...
[[file:image/experiment/screenshot-2019-05-28-10-02-48.png]]

- MSTP-NO
  [[file:image/experiment/screenshot-2019-05-28-09-28-28.png]]

  [[file:image/experiment/screenshot-2019-05-28-09-29-39.png]]

  [[file:image/experiment/screenshot-2019-05-28-09-30-06.png]]

- RSTP-NO
  [[file:image/experiment/screenshot-2019-05-28-09-49-29.png]]

  [[file:image/experiment/screenshot-2019-05-28-09-49-58.png]]

  [[file:image/experiment/screenshot-2019-05-28-09-50-21.png]]

- RSTP-MSTP
  [[file:image/experiment/screenshot-2019-05-28-10-00-00.png]]
  
  [[file:image/experiment/screenshot-2019-05-28-10-00-24.png]]

  [[file:image/experiment/screenshot-2019-05-28-10-00-44.png]]

  [[file:image/experiment/screenshot-2019-05-28-10-01-00.png]]

  [[file:image/experiment/screenshot-2019-05-28-10-01-12.png]]

  [[file:image/experiment/screenshot-2019-05-28-10-01-26.png]]
** MSTP Comprehensive

[[file:image/experiment/screenshot-2019-05-28-10-42-50.png]]
...
- http_server
  #+BEGIN_EXAMPLE
    ...
    interface Ethernet0/0
     no shutdown
     ip address 217.90.1.1 255.255.255.0
    !
    router ospf 90
     network 217.90.1.0 0.0.0.255 area 0
    !
    ip http server
  #+END_EXAMPLE
...
- Internet
  #+BEGIN_EXAMPLE
    ...
    interface Ethernet0/0
     no shutdown
     ip address 217.90.1.10 255.255.255.0
    !
    interface Ethernet0/1
     no shutdown
     ip address 202.100.1.10 255.255.255.224
    !
    router ospf 90
     network 202.100.1.0 0.0.0.31 area 0
     network 217.90.1.0 0.0.0.31 area 0
     network 217.90.1.0 0.0.0.255 area 0
    !
  #+END_EXAMPLE
...
- Route
  #+BEGIN_EXAMPLE
    ...
    interface Ethernet0/0
     no shutdown
     ip address 202.100.1.1 255.255.255.224
     ip nat outside
    !
    interface Ethernet0/1
     no shutdown
...
- Core1
  #+BEGIN_EXAMPLE
    ...
    interface Vlan1
     no shutdown
     ip address 10.1.1.10 255.255.255.0
     vrrp 1 ip 10.1.1.200
    !
    interface Vlan2
     no shutdown
     ip address 172.16.1.10 255.255.255.0
     vrrp 2 ip 172.16.1.200
    !
    interface Vlan3
     no shutdown
...
** R-O-E
[[file:image/experiment/screenshot-2019-05-29-18-48-13.png]]
...
- R2
  #+BEGIN_EXAMPLE
    ...
    router eigrp 90
     ...
     redistribute ospf 90 metric 10000 10 255 100 1500 route-map O-E
     no auto-summary
    !
    router ospf 90
    ...
    !
    ip prefix-list 3 seq 5 permit 24.1.1.0/24
    !
...
- R3
  #+BEGIN_EXAMPLE
    ...
    !
    router eigrp 90
     distribute-list route-map deny24 in 
     network 3.3.3.0 0.0.0.255
     network 23.1.1.0 0.0.0.255
     no auto-summary
    !
    route-map deny24 deny 10
     match tag 24
    !
    route-map deny24 permit 20
    !
  #+END_EXAMPLE
- R4
  #+BEGIN_EXAMPLE
